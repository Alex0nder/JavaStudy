package Year2023.Task37_OOP_StaticFinalArguments.box;

public class Box {
    // All fields private, all constructors and methods public,
    // we can not change width, height and length box, because
    // read-only access, create a getter for each field
